...
<head>
     ...
     <title>Ifeanyi Ojo - Official Website</title>
<!-- 
Hydro Template 
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand">Ifeanyi Ojo</a>
               </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="home-info">
                              <h1>Hello, I'm glad you could visit ☺.</h1>
                              <a href="#" class="btn section-btn smoothScroll">Connect</a>
                              <span>
                                   CALL ME (+234) 080-388-36525
               ...
               <div class="row">
                    ...
                    <div class="col-md-5 col-sm-6">
                         <div class="about-info">
                              ...
                              <p>Aside Programming, i enjoy watching sci-fi and Comedy genre movies and I Love Animals (Favorite: Dogs and Cats)</p>
                         </div>
                    </div>
